...
public class ContentViewProcessor extends AbstractProcessor {
    ...
    public String generateCode(Map<String, Integer> map) {
        ...
        builder.append("// Class generated by ContentViewAnnotation").append("\n");
        builder.append("// Fork or star me on GitHub: https://github.com/DrkCore/ContentViewAnnotation").append("\n");
        builder.append("public class ").append(API_NAME).append(" {").append("\n\n");
